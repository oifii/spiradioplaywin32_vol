...
// spiradioplaywin32_vol.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "spiradioplaywin32_vol.h"
#include "FreeImage.h"
...
//LeaveCriticalSection(&global_lock);
	...
	else
	{
		...
		{
			float fvolume = 0.0;
			BASS_ChannelSetAttribute(global_chan, BASS_ATTRIB_VOL, fvolume);
			do_once=false;
		}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		{
			//fvolume = 0.0;
			fvolume = 1.0 - ymousepos/(global_staticheight+0.0f); //0.0;
			BASS_ChannelSetAttribute(global_chan, BASS_ATTRIB_VOL, fvolume);
		}
		break;
	case WM_SIZE:
